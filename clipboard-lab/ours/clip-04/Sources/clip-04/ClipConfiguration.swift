...
final class ConfigController {
    ...
    private let streamQueue = DispatchQueue(label: "local.clip04.config")
    ...
    init(fileManager: FileManager = .default) throws {
        ...
        supportDirectoryURL = supportRoot.appendingPathComponent("clip-04", isDirectory: true)
